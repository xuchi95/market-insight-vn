      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8 lg:py-12 max-w-3xl space-y-6">
          ...
          <section className="prose dark:prose-invert max-w-none space-y-4 text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-xl font-semibold text-foreground">1. Cookie là gì?</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-foreground">2. Cơ sở pháp lý sử dụng Cookie</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">3. Phân loại Cookie Chúng tôi sử dụng</h2>

            <h3 className="text-base font-semibold text-foreground mt-4">3.1. Cookie thiết yếu (Strictly Necessary)</h3>
            <p>
            ...
            <h3 className="text-base font-semibold text-foreground mt-4">3.2. Cookie chức năng (Functional)</h3>
            ...
            <h3 className="text-base font-semibold text-foreground mt-4">3.3. Cookie phân tích (Analytics)</h3>
            ...
            <h3 className="text-base font-semibold text-foreground mt-4">3.4. Cookie tiếp thị (Marketing)</h3>
            <p>
            ...
            <h2 className="text-xl font-semibold text-foreground">4. Cookie của bên thứ ba</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">5. Thời hạn lưu trữ Cookie</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-foreground">6. Quyền của Bạn đối với Cookie</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">7. Cách quản lý và tắt Cookie</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">8. Trẻ em</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-foreground">9. Liên hệ về Cookie và dữ liệu cá nhân</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-foreground">10. Sửa đổi Chính sách</h2>
            <p>
