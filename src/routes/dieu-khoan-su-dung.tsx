      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8 lg:py-12 max-w-3xl space-y-6">
          ...
          <section className="prose prose-invert max-w-none space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>Người dùng cam kết KHÔNG thực hiện các hành vi sau (căn cứ Điều 8, Điều 16, Điều 17, Điều 18 Luật An ninh mạng 2018; Điều 5 Nghị định 72/2013/NĐ-CP; Điều 101 Nghị định 15/2020/NĐ-CP):</p>
            <ul className="list-disc pl-6 space-y-2">
