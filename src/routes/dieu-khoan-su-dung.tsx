    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8 lg:py-12 max-w-3xl space-y-6">
          ...
          <section ref={contentRef} className="policy-prose prose prose-slate dark:prose-invert max-w-none space-y-6 text-[17px] md:text-[18px] leading-[1.85] text-muted-foreground">
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">1. Định nghĩa và giải thích thuật ngữ</h2>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">2. Chấp nhận điều khoản</h2>
            <p>
              Khi truy cập, đăng ký tài khoản, đăng ký bản tin, sử dụng bất kỳ chức năng nào của Website, Bạn xác nhận: (i) đã đủ năng lực hành vi dân sự theo Bộ luật Dân sự 2015 (đủ 18 tuổi hoặc có người đại diện hợp pháp đối với người chưa thành niên); (ii) đã đọc, hiểu và đồng ý đầy đủ Điều khoản này cùng <Link to="/chinh-sach-bao-mat" className="text-primary underline-offset-4 hover:underline font-medium">Chính sách dữ liệu & quyền riêng tư</Link> và <Link to="/mien-tru-trach-nhiem" className="text-primary underline-offset-4 hover:underline font-medium">Tuyên bố miễn trừ trách nhiệm</Link>; (iii) cam kết tuân thủ pháp luật Việt Nam và pháp luật nơi Bạn cư trú khi sử dụng Website. Nếu không đồng ý bất kỳ điều khoản nào, vui lòng ngừng truy cập ngay lập tức.
            </p>

            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">3. Bản chất và mục đích của Website</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">4. Tài khoản người dùng</h2>
            <ul className="list-disc pl-6 space-y-2 marker:text-primary/60">
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">5. Quy tắc ứng xử và các hành vi bị nghiêm cấm</h2>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">6. Quyền sở hữu trí tuệ</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">7. Nội dung do người dùng cung cấp</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">8. Liên kết đến bên thứ ba</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">9. Dịch vụ miễn phí và quyền thay đổi</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">10. Tuyên bố từ chối bảo đảm và giới hạn trách nhiệm</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">12. Bất khả kháng</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">13. Bảo vệ dữ liệu cá nhân</h2>
            <p>
              Việc thu thập, xử lý, lưu trữ, chuyển giao dữ liệu cá nhân của Người dùng được thực hiện theo <Link to="/chinh-sach-bao-mat" className="text-primary underline-offset-4 hover:underline font-medium">Chính sách dữ liệu & quyền riêng tư</Link>, tuân thủ đầy đủ Nghị định 13/2023/NĐ-CP. Bằng việc sử dụng Website, Người dùng đồng ý với việc xử lý dữ liệu cá nhân theo chính sách nêu trên.
            </p>

            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">14. Chấm dứt sử dụng</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">15. Sửa đổi Điều khoản</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">16. Giải quyết tranh chấp</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">17. Luật áp dụng và hiệu lực từng phần</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mt-8 mb-2 scroll-mt-24">18. Thông tin liên hệ</h2>
            <p>
