    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Dataset",
          name: "Bảng giá vàng Việt Nam realtime — SJC, DOJI, PNJ, BTMC, Phú Quý + XAU/USD",
          description: "Dữ liệu giá vàng miếng và nhẫn tròn trơn của các thương hiệu lớn nhất Việt Nam, cập nhật mỗi 5 giây. Bao gồm giá vàng thế giới XAU/USD theo ounce.",
          url: URL,
          inLanguage: "vi-VN",
          keywords: ["giá vàng SJC", "giá vàng DOJI", "giá vàng PNJ", "XAU/USD", "giá vàng hôm nay"],
          ...
          variableMeasured: ["Giá mua vào (VND/lượng)", "Giá bán ra (VND/lượng)", "Giá XAU/USD (USD/ounce)"],
        }),
      },
    ],
  }),
