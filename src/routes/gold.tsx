    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            { "@type": "ListItem", position: 1, name: "Giá vàng SJC", item: { "@type": "Product", name: "Vàng SJC", description: "Giá vàng miếng SJC hôm nay — mua vào, bán ra" } },
            { "@type": "ListItem", position: 2, name: "Giá vàng DOJI", item: { "@type": "Product", name: "Vàng DOJI", description: "Giá vàng DOJI hôm nay — mua vào, bán ra" } },
            { "@type": "ListItem", position: 3, name: "Giá vàng PNJ", item: { "@type": "Product", name: "Vàng PNJ", description: "Giá vàng PNJ hôm nay — mua vào, bán ra" } },
            { "@type": "ListItem", position: 4, name: "Giá vàng Bảo Tín Minh Châu", item: { "@type": "Product", name: "Vàng Bảo Tín Minh Châu", description: "Giá vàng BTMC hôm nay — mua vào, bán ra" } },
            { "@type": "ListItem", position: 5, name: "Giá vàng Phú Quý", item: { "@type": "Product", name: "Vàng Phú Quý", description: "Giá vàng Phú Quý hôm nay — mua vào, bán ra" } },
            { "@type": "ListItem", position: 6, name: "Giá vàng thế giới XAU/USD", item: { "@type": "Product", name: "XAU/USD", description: "Giá vàng thế giới theo ounce" } },
          ],
        }),
      },
    ],
