    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Dataset",
          name: "Bảng so sánh lãi suất tiết kiệm 20+ ngân hàng Việt Nam",
          description: "Lãi suất gửi tiết kiệm thông thường (VND, lĩnh lãi cuối kỳ) tại Vietcombank, BIDV, Techcombank, MB, ACB, VPBank… các kỳ hạn 1, 3, 6, 9, 12, 24, 36 tháng — rà soát hàng ngày từ biểu lãi suất công khai của từng ngân hàng.",
          url: URL,
          inLanguage: "vi-VN",
          keywords: ["lãi suất tiết kiệm", "lãi suất ngân hàng", "lãi suất 12 tháng", "so sánh lãi suất"],
          ...
          variableMeasured: ["Lãi suất theo kỳ hạn (%/năm)"],
        }),
      },
    ],
  }),
