      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8 lg:py-12 max-w-3xl space-y-6">
          ...
          <section className="prose prose-invert max-w-none space-y-4 text-muted-foreground leading-relaxed">
            ...
            <h2 className="text-xl font-semibold text-foreground">1. Phạm vi áp dụng</h2>
            <p>
              Chính sách áp dụng cho mọi cá nhân truy cập, sử dụng Website tại tên miền <a href="https://marketwatch.vn" className="text-foreground underline">marketwatch.vn</a> và các tên miền phụ liên quan, bao gồm cả khách truy cập không đăng ký và Người dùng đã đăng ký tài khoản. Chính sách KHÔNG áp dụng cho website, dịch vụ của bên thứ ba mà Website có liên kết tới.
            </p>
            ...
            <h3 className="text-base font-semibold text-foreground mt-4">3.1. Dữ liệu cá nhân cơ bản</h3>
            ...
            <h3 className="text-base font-semibold text-foreground mt-4">3.2. Dữ liệu kỹ thuật và nhật ký</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-base font-semibold text-foreground mt-4">3.3. Dữ liệu sử dụng dịch vụ</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-foreground">4. Mục đích xử lý dữ liệu cá nhân</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">5. Căn cứ pháp lý xử lý dữ liệu</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-foreground">6. Cookie và công nghệ tương tự</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">7. Chia sẻ dữ liệu cho bên thứ ba</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-foreground">8. Chuyển dữ liệu ra nước ngoài</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-foreground">9. Thời gian lưu trữ dữ liệu</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-foreground">10. Biện pháp bảo mật</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-foreground">11. Quyền của Chủ thể dữ liệu</h2>
            ...
            <h2 className="text-xl font-semibold text-foreground">12. Bảo vệ dữ liệu cá nhân của trẻ em</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-foreground">13. Thông báo vi phạm dữ liệu</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Quản lý bản tin / huỷ nhận email: <Link to="/cai-dat/ban-tin" className="text-foreground underline">marketwatch.vn/cai-dat/ban-tin</Link> hoặc liên kết “Huỷ đăng ký” trong từng email.</li>
            </ul>
            <p>
            ...
            <h2 className="text-xl font-semibold text-foreground">15. Thay đổi Chính sách</h2>
            <p>
