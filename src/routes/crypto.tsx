    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            { "@type": "ListItem", position: 1, name: "Giá Bitcoin (BTC)", item: { "@type": "Product", name: "Bitcoin", description: "Giá BTC hôm nay theo USD và VND" } },
            { "@type": "ListItem", position: 2, name: "Giá Ethereum (ETH)", item: { "@type": "Product", name: "Ethereum", description: "Giá ETH hôm nay theo USD và VND" } },
            { "@type": "ListItem", position: 3, name: "Giá Tether (USDT)", item: { "@type": "Product", name: "Tether", description: "Giá USDT hôm nay theo USD và VND" } },
            { "@type": "ListItem", position: 4, name: "Giá BNB", item: { "@type": "Product", name: "BNB", description: "Giá BNB hôm nay theo USD và VND" } },
            { "@type": "ListItem", position: 5, name: "Giá Solana (SOL)", item: { "@type": "Product", name: "Solana", description: "Giá SOL hôm nay theo USD và VND" } },
            { "@type": "ListItem", position: 6, name: "Giá XRP", item: { "@type": "Product", name: "XRP", description: "Giá XRP hôm nay theo USD và VND" } },
            { "@type": "ListItem", position: 7, name: "Giá Dogecoin (DOGE)", item: { "@type": "Product", name: "Dogecoin", description: "Giá DOGE hôm nay theo USD và VND" } },
            { "@type": "ListItem", position: 8, name: "Giá TON", item: { "@type": "Product", name: "TON", description: "Giá TON hôm nay theo USD và VND" } },
          ],
        }),
      },
    ],
