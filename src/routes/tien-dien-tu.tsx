    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Dataset",
          name: "Giá Bitcoin & altcoin (BTC, ETH, USDT, BNB, SOL, XRP…) — realtime USD và VND",
          description: "Dữ liệu giá crypto theo USD và quy đổi VND, vốn hoá và volume 24h cho hàng trăm đồng coin, cập nhật mỗi 15 giây từ thị trường toàn cầu.",
          url: URL,
          inLanguage: "vi-VN",
          keywords: ["giá Bitcoin", "giá Ethereum", "giá USDT", "giá BNB", "giá Solana", "crypto VND"],
          isAccessibleForFree: true,
          license: "https://marketwatch.vn/dieu-khoan-su-dung",
          creator: { "@id": SITE + "/#organization" },
          publisher: { "@id": SITE + "/#organization" },
          temporalCoverage: new Date().toISOString().slice(0, 10),
          variableMeasured: ["Giá (USD)", "Giá (VND)", "Vốn hoá", "Volume 24h", "Biến động 24h (%)"],
        }),
      },
    ],
  }),
