    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            ...
            {
              "@type": "Dataset",
              name: "Giá xăng dầu Việt Nam (Petrolimex) + giá dầu Brent, WTI thế giới",
              description: "Bảng giá Petrolimex theo kỳ điều hành 7 ngày của Liên Bộ Công Thương – Tài chính và giá dầu thô Brent (ICE), WTI (NYMEX) realtime theo USD/thùng.",
              url: URL,
              inLanguage: "vi-VN",
              keywords: ["giá xăng dầu", "giá xăng Petrolimex", "giá dầu Brent", "giá dầu WTI", "RON 95", "E5 RON 92"],
              ...
              variableMeasured: ["Giá bán lẻ (VND/lít)", "Giá Brent (USD/thùng)", "Giá WTI (USD/thùng)"],
            },
          ],
        }),
      },
